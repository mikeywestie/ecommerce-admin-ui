      ...
      <div className="max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-800 p-5 sm:p-6">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold">E-commerce Platform Documentation</h2>
        ...
        <div className="border-b border-slate-800 px-5 pt-4 sm:px-6">
          <div className="flex flex-wrap gap-2">
            <TabButton
              active={activeInfoTab === "readme"}
              onClick={() => setActiveInfoTab("readme")}
            >
              README
            </TabButton>
            <TabButton
              active={activeInfoTab === "architecture"}
              onClick={() => setActiveInfoTab("architecture")}
            >
              Architecture
            </TabButton>
            <TabButton
              active={activeInfoTab === "releaseNotes"}
    ...
    <div className="space-y-6 text-sm leading-6 text-slate-300">
      <section className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4">
        ...
        <p className="mt-2 text-slate-300">
          Full Stack Java Developer focused on Spring Boot, REST APIs, React, PostgreSQL, security,
          and production-style portfolio systems.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          This is a full-stack e-commerce portfolio demo built with a Spring Boot API, React
          frontend, PostgreSQL persistence, role-based authentication, admin operations, and a
          customer storefront flow.
        </p>
      </section>
      <section>
        <h3 className="text-lg font-bold text-white">Why I built this</h3>
        <p className="mt-2">
          I built this project to demonstrate practical enterprise Java development skills beyond a
          simple CRUD app. It shows authentication, API design, cloud deployment, admin workflows,
          customer workflows, monitoring, and frontend integration.
        </p>
      </section>
      ...
      <section>
        <h3 className="text-lg font-bold text-white">Business value</h3>
        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>Manage inventory and product availability.</li>
          <li>Monitor orders, payments, and checkout outcomes.</li>
          <li>Reduce manual administration through a central dashboard.</li>
          <li>Separate admin and customer experiences using role-based access.</li>
          <li>Demonstrate real-world enterprise patterns in a portfolio-friendly way.</li>
        </ul>
      </section>
...
function ArchitectureTab() {
  return (
    <div className="space-y-6 text-sm leading-6 text-slate-300">
      <section>
        <h3 className="text-lg font-bold text-white">High-level architecture</h3>
      ...
      <section>
        <h3 className="text-lg font-bold text-white">Architecture highlights</h3>

        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          <InfoPill label="Security" value="JWT auth + role-based access" />

          <InfoPill label="API" value="REST endpoints for admin and customer flows" />

          <InfoPill label="Monitoring" value="Spring Boot Actuator health checks" />

          <InfoPill label="Deployment" value="Frontend and backend deployed separately" />
        </div>
      </section>

      <section>
        <h3 className="text-lg font-bold text-white">Hosting & Infrastructure</h3>

        <div className="mt-3 grid gap-3 sm:grid-cols-3">
          <InfoPill label="Frontend Hosting" value="GitHub Pages" />

          <InfoPill label="Backend Hosting" value="Render" />

          <InfoPill label="Database" value="Supabase PostgreSQL" />
        </div>
      </section>

      <section>
        <h3 className="text-lg font-bold text-white">User flows</h3>

        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>
            Admin users can view dashboards, orders, payments, coupons, inventory, and system
            health.
          </li>

          <li>Customer users can browse products, add items to cart, checkout, and view orders.</li>

          <li>
            The login screen selects demo credentials and redirects users based on their
            authenticated role.
          </li>
        </ul>
      </section>
  ...
  return (
    <div className="space-y-6 text-sm leading-6 text-slate-300">
      <section className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-4">
        ...
        <h3 className="mt-4 text-lg font-bold text-white">Project status</h3>
        <p className="mt-2">Current version: 1.9.0</p>
        <p>Last updated: June 2026</p>
      </section>
      <section>
        <h3 className="text-lg font-bold text-white">Latest changes</h3>
        <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <li>
            Added admin modules for dashboard, inventory, payments, orders, coupons, and system
            health.
          </li>
      ...
      <section>
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>
            The backend is hosted on Render, so the first request may be slower after inactivity.
          </li>
          <li>
            Kafka is not required for the live demo environment and may be disabled in cloud
            deployment.
          </li>
